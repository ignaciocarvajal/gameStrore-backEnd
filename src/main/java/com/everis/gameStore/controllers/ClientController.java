...
public class ClientController {
	...
	public ResponseEntity<ClientsListResponseDTO> getAllClients() throws ServiceException {
		try {
			return new ResponseEntity<ClientsListResponseDTO>(clientFacade.getAllClients(), HttpStatus.OK);
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
	...
	public ResponseEntity<Void> updateClient(@RequestBody BigInteger idClient) throws ServiceException {
		try {
			clientFacade.updateClient(idClient);
